...
*  v1.0.1f2- 1/12/93: GetFile path now set to folder of last frame file.
*                     (GregT, DinoB) - T2v1.0.1b4
*                     Optimized parts, especially the error handler (DerekY)
*  v1.0.1f3-4- late Jan 93: revised for new G2MF changes - T2v1.0.1f1&2
*
* Inputs:
*
* |previous contents|
...
;	brk
	...
	lda	ErrorMsg
	cmp	#6	;errors 1 through 5 are good
;	bge	unknown
	blt	known
	stz	<T2Result
	stz	<T2Result+2
...
Errors	dc	a'PathRezErrMsg'	; error 1
	dc	a'OSErrMsg'	; error 2
	dc	a'MemErrMsg'	; error 3
	dc	a'APFErrMsg'	; error 4
	dc	a'ATFErrMsg'	; error 5

ErrorLengths	dc	i'PathRezErrLen,OSErrLen,MemErrLen,APFErrLen,ATFErrLen'

PathRezErrMsg	anop
	dc	c'Twilight II '
	dc	h'd2',c'YouDrawIt!',h'd3'
	dc	c' Module Error:',h'0d'
	dc	c'Animation pathname not set up! ($'
ascii0	dc	c'????)',h'00'
PathRezErrEnd	anop
...
OSErrMsg	anop
	...
	dc	h'd2',c'YouDrawIt!',h'd3'
	dc	c' Module Error:',h'0d'
	dc	c'Can''t read/find selected anim template file! ($'
ascii1	dc	c'????)',h'00'
OSErrEnd	anop
...
MemErrMsg	anop
	...
	dc	h'd2',c'YouDrawIt!',h'd3'
	dc	c' Module Error:',h'0d'
	dc	c'Can''t allocate enough memory to run! ($'
ascii2	dc	c'????)',h'00'
MemErrEnd	anop
...
APFErrMsg	anop
	...
	dc	h'd2',c'YouDrawIt!',h'd3'
	dc	c' Module Error:',h'0d'
	dc	c'Bad animation template file (APF header invalid)!',h'00'
APFErrEnd	anop
...
ATFErrMsg	anop
	...
	dc	h'd2',c'YouDrawIt!',h'd3'
	dc	c' Module Error:',h'0d'
	dc	c'Bad anim template file '
	dc	c'(number of frames incorrectly marked)!',h'00'
ATFErrEnd	anop
