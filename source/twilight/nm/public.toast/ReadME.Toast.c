...
Why we’re releasing this:
	...
	As a teaser, here are the prizes. Since there’s 3 contests (one each for Fish, Toast & Globe), there are actually 3 first prizes (one in each), 3 second places, and so on
...
Anything we decide to publish: Twilight II v1.2
	...
	Thus, even if you don’t win first, second, or third, you still could have your name in print and get cool new software!
...
5. Anything else I can’t think of at the moment. (Finals just finished here, and my brain’s not working too well)
